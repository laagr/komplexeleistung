...
\section{Einleitung}
\dm{0.95}{2,718281828459045235360287471\dots} und so weiter und so fort - diese endlose Kette von Zahlen, die sich aus der Konstante $e$ ergeben, führen uns in eine faszinierende Welt der Wissenschaft und Mathematik. Als Erstes jedoch unternehme ich einen Exkurs in die Geschichte und bestimme die Verhältnisse, unter der die Eulersche Zahl entdeckt und angewendet wurde und wie genau Euler selbst damit in Verbindung stand. Danach untersuche ich die Anwendung der Eulerschen Zahl in Gleichungen wie \[
  e^x = \frac{de^x}{dx}  
\] und \[
e^{i\theta} = i\sin{\theta} + \cos{\theta}
\] Wobei ich in reelle Analysis und komplexe Analysis unterteile. 
